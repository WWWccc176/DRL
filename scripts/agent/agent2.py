...
class LatticeEnv:
    def __init__(
        ...
        self.current_matrix_str = self.initial_matrix_str
        self.last_rust_info = init_res
    ...
    def reset(self):
        ...
        res = my_project_backend.run_reduction_rust(self.current_matrix_str, "LLL", 2)
    ...
    def step(self, action_idx):
        ...
        if new_ratio < self.best_ratio:
            breakthrough_bonus = 50.0  # 打破全局历史记录，给极其夸张的奖励
...
if __name__ == "__main__":
    ...
    # 限制 PyTorch 的 CPU 线程数，防止其与底层的 Rust 抢占 CPU 资源
    ...
    for dim in DIMS_TO_RUN:
        ...
        try:
            ...
            break  # 允许你按 Ctrl+C 直接退出整个程序，不再产生僵尸进程
