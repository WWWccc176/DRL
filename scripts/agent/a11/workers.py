...
from .config import (
    ...
    SIEVE_BGJ_MAX_SECONDS,
    SIEVE_DH_TARGET_61_79,
    SIEVE_DH_TARGET_80_94,
    SIEVE_DH_TARGET_95,
    SIEVE_FREE_DIM,
    SIEVE_FREE_DIM_CAP,
    SIEVE_INSERT_ETA,
    ...
    SIEVE_NO_PROGRESS_SECONDS,
    SIEVE_NO_SOLUTION_SECONDS,
    SIEVE_RECOVERY_RESERVE_SECONDS,
    SIEVE_REPORT_SECONDS,
    SIEVE_QUEUE_SIZE,
    SIEVE_RESPONSE_POLL_SECONDS,
    SIEVE_SERVICE_CLOSE_SECONDS,
    SIEVE_TIME_BUDGET_S,
    SIEVE_VECTOR_MULTIPLIER,
    SIEVE_WORKDIR,
...
def _sieve_worker_main(
    ...
    os.environ["LATTICE_SIEVE_MAX_SECONDS"] = str(SIEVE_TIME_BUDGET_S)
    os.environ["LATTICE_SIEVE_BGJ_MAX_SECONDS"] = str(SIEVE_BGJ_MAX_SECONDS)
    os.environ["LATTICE_SIEVE_NO_SOLUTION_SECONDS"] = str(
        SIEVE_NO_SOLUTION_SECONDS
    )
    os.environ["LATTICE_SIEVE_NO_PROGRESS_SECONDS"] = str(
        SIEVE_NO_PROGRESS_SECONDS
    )
    os.environ["LATTICE_SIEVE_REPORT_SECONDS"] = str(SIEVE_REPORT_SECONDS)
    os.environ["LATTICE_SIEVE_VECTOR_MULTIPLIER"] = str(
        SIEVE_VECTOR_MULTIPLIER
    )
    os.environ["LATTICE_SIEVE_MAX_VECTORS"] = str(SIEVE_MAX_VECTORS)
    os.environ["LATTICE_SIEVE_INSERT_ETA"] = str(SIEVE_INSERT_ETA)
    os.environ["LATTICE_SIEVE_ENABLE_DH"] = "1"
    os.environ["LATTICE_SIEVE_RECOVERY_RESERVE_SECONDS"] = str(
        SIEVE_RECOVERY_RESERVE_SECONDS
    )
    os.environ["LATTICE_SIEVE_DH_TARGET_61_79"] = str(
        SIEVE_DH_TARGET_61_79
    )
    os.environ["LATTICE_SIEVE_DH_TARGET_80_94"] = str(
        SIEVE_DH_TARGET_80_94
    )
    os.environ["LATTICE_SIEVE_DH_TARGET_95"] = str(SIEVE_DH_TARGET_95)
